...
<div class="content-header">
    <div class="container">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 fw-bold">Add Component</h1>
            </div>
            ...
            <div class="col-lg-12">
                ...
                <div class="card shadow">
                    <div class="card-header bg-white">
                        <h5 class="m-0 fw-bold"><i class="bi bi-plus-circle me-2"></i>Add New Component</h5>
                    </div>
                    <div class="card-body form-container p-4">
                        <form action="{{ route('components.store') }}" method="POST" enctype="multipart/form-data" novalidate>
                            @csrf
                            <div class="row">
                                <!-- First Column -->
                                <div class="col-md-6">
                            ...
                            <!-- Component-specific Custom Fields - Will be added here by JS -->
                            <div id="component-fields-container"></div>
                            
                            <!-- Category-specific Custom Fields - Will be added here by JS -->
                            <div id="category-custom-fields"></div>

                            <!-- Submit button -->
                            <div class="mt-4 text-end">
                                <button type="submit" class="btn btn-dark"><i class="bi bi-plus-lg me-2"></i>Add Component</button>
                            </div>
                        </form>
                    </div>
                </div>
