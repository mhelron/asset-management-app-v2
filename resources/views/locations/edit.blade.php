                        ...
                        <form action="{{ route('locations.update', $location->id) }}" method="POST">
                            ...
                            <div class="col-md-12">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="name" value="{{ old('name', $location->name) }}" class="form-control" placeholder="Enter location name">
                                    @error('name')
                            ...
                            <div class="col-md-12">
                                <div class="form-group mb-3">
                                    ...
                                    <textarea name="desc" class="form-control" placeholder="Enter address">{{ old('desc', $location->desc) }}</textarea>
                                    @error('desc')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                            ...
                            <!-- Submit button -->
                            <div class="form-group mb-3">
                                <button type="submit" class="btn btn-dark float-end"><i class="bi bi-pencil-square me-2"></i>Update Location</button>
                            </div>
