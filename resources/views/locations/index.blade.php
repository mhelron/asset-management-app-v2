...
<div class="content-header">
    <div class="container">
        <div class="row mb-2">
            <div class="col-md-6">
                <h1 class="m-0 fw-bold">Locations</h1>
            </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="d-flex justify-content-end mb-3 action-buttons">
                    <a href="{{ route('locations.create') }}" class="btn btn-dark"><i class="bi bi-plus-lg me-2"></i>Add Location</a>
                </div>

                <!-- Locations Table -->
                <div class="card shadow">
                    <div class="card-header bg-white d-flex justify-content-between align-items-center">
                        <h5 class="m-0 fw-bold">Locations List</h5>
                    </div>
                    <div class="card-body">
                            ...
                            <table class="table table-striped table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{ $index + 1 }}</td>
                                        <td>{{ $location->name }}</td>
                                        <td>{{ Str::limit($location->desc, 30) }}</td>
                                        <td><span class="badge {{ $location->status == 'Active' ? 'bg-success' : 'bg-secondary' }}">{{ $location->status }}</span></td>
                                        <td>
                                            <div class="d-flex">
                                                <a href="{{ route('locations.edit', $location->id) }}" class="btn btn-sm btn-success me-2"><i class="bi bi-pencil-square"></i></a>
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        archiveButtons.forEach(button => {
            button.addEventListener('click', function() {
                ...
                archiveForm.action = "{{ url('locations/archive-location/') }}/" + fieldId;
            });
        });
    });
</script>
